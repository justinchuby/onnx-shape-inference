...
@_reg("", "Mish", since_version=18)
@_reg("", "Shrink", since_version=9)
@_reg("", "Swish", since_version=24)
@_reg("", "Trilu", since_version=14)
@_reg("", "Abs", since_version=1)
...
@_reg("", "Clip", since_version=1)
@_reg("", "Cos", since_version=7)
@_reg("", "Cosh", since_version=9)
@_reg("", "Elu", since_version=1)
@_reg("", "Erf", since_version=9)
@_reg("", "Exp", since_version=1)
@_reg("", "Gelu", since_version=20)
@_reg("", "HardSigmoid", since_version=1)
@_reg("", "HardSwish", since_version=14)
@_reg("", "LeakyRelu", since_version=1)
@_reg("", "Log", since_version=1)
@_reg("", "Reciprocal", since_version=1)
@_reg("", "Relu", since_version=1)
@_reg("", "Round", since_version=11)
@_reg("", "Selu", since_version=1)
@_reg("", "Sigmoid", since_version=1)
...
@_reg("", "Sqrt", since_version=1)
@_reg("", "Tan", since_version=7)
@_reg("", "Tanh", since_version=1)
...
@_reg("", "Floor", since_version=1)
@_reg("", "Ceil", since_version=1)
@_reg("", "Neg", since_version=1)
